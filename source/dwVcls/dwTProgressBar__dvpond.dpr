library dwTProgressBar__dvpond;
...
begin
    with TProgressBar(ACtrl) do begin
        ...
        //
        Result  := joRes;   //'{value: '+IntToStr(Position)+'}'
    end;
...
begin
     ...
     //生成返回值数组
     joRes.Add('</dv-percent-pond>');               //此处需要和dwGetHead对应
     //
     Result    := (joRes);
end;
