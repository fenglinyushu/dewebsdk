...
uses
     ...
     StdCtrls, Windows,Vcl.WinXPanels,Vcl.WinXCtrls;
...
var
     joData    : Variant;
begin
    with TStackPanel(ACtrl) do begin
        //
        joData    := _Json(AData);

        if joData.e = 'onclick' then begin
            TStackPanel(ACtrl).OnClick(TStackPanel(ACtrl));
        end else if joData.e = 'onenter' then begin
            TStackPanel(ACtrl).OnEnter(TStackPanel(ACtrl));
        end else if joData.e = 'onexit' then begin
            TStackPanel(ACtrl).OnExit(TStackPanel(ACtrl));
        end;
    end;
end;
...
begin
    with TStackPanel(ACtrl) do begin
        ...
        with TStackPanel(ACtrl) do begin
            ...
            //
            if TStackPanel(ACtrl).Color = clNone then begin
