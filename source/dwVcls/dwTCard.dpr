...
uses
     ...
     Controls, Forms, Dialogs, ComCtrls, ExtCtrls,Vcl.WinXPanels,
     StdCtrls, Windows;
...
begin
    with TCard(ACtrl) do begin
        ...
        if joData.e = 'onclick' then begin
            TCard(ACtrl).OnClick(TCard(ACtrl));
        end else if joData.e = 'onenter' then begin
            TCard(ACtrl).OnEnter(TCard(ACtrl));
        end else if joData.e = 'onexit' then begin
            TCard(ACtrl).OnExit(TCard(ACtrl));
        end;
    end;
end;
