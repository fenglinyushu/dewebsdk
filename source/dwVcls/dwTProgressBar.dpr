...
begin
     ...
     with TProgressBar(ACtrl) do begin
          ...
          sCode     := sCode
                    ...
                    +' define-back-color="'+dwColor(BackGroundColor)+'"'
                    +' text-color="'+dwGetStr(joHint,'textcolor','#ffffff')+'"'
...
begin
    ...
    with TProgressBar(ACtrl) do begin
        ...
        //高度
        joRes.Add(dwFullName(Actrl)+'__stw:'+IntToStr(dwGetInt(joHint,'strokewidth',6))+',');
        //在内显示文本
        joRes.Add(dwFullName(Actrl)+'__tid:'+dwIIF(SmoothReverse,'true,','false,'));
        //Bar颜色
        joRes.Add(dwFullName(Actrl)+'__clr:"'+dwColor(BarColor)+'",');
        //背景颜色
        joRes.Add(dwFullName(Actrl)+'__bgc:"'+dwColor(BackGroundColor)+'",');
        //文字 颜色
        joRes.Add(dwFullName(Actrl)+'__txc:"'+dwGetStr(joHint,'textcolor','#fff')+'",');
        //>------
    end;
    //
    Result    := (joRes);
...
begin
    ...
    with TProgressBar(ACtrl) do begin
        ...
        //高度
        joRes.Add('this.'+dwFullName(Actrl)+'__stw='+IntToStr(dwGetInt(joHint,'strokewidth',6))+';');
        //在内显示文本
        ...
        //背景颜色
        joRes.Add('this.'+dwFullName(Actrl)+'__bgc="'+dwColor(BackGroundColor)+'";');
        //文字 颜色
        joRes.Add('this.'+dwFullName(Actrl)+'__txc="'+dwGetStr(joHint,'textcolor','#fff')+'";');
        //>------
    end;
    //
    Result    := (joRes);
