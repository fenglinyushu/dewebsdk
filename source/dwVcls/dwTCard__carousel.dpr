...
begin
    ...
    with TCard(ACtrl) do begin
        ...
        //joRes.Add(dwFullName(Actrl)+'__wid:"'+IntToStr(TCardPanel(Parent).Width)+'px",');
        //joRes.Add(dwFullName(Actrl)+'__hei:"'+IntToStr(TCardPanel(Parent).Height)+'px",');
        //
