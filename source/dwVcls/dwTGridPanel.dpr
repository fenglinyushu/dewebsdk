...
var
     joData    : Variant;
begin
    with TGridPanel(ACtrl) do begin
        //
        joData    := _Json(AData);

        if joData.e = 'onclick' then begin
            TGridPanel(ACtrl).OnClick(TGridPanel(ACtrl));
        end else if joData.e = 'onenter' then begin
            TGridPanel(ACtrl).OnEnter(TGridPanel(ACtrl));
        end else if joData.e = 'onexit' then begin
            TGridPanel(ACtrl).OnExit(TGridPanel(ACtrl));
        end;
    end;
end;
...
begin
    with TGridPanel(ACtrl) do begin
        ...
        with TGridPanel(ACtrl) do begin
            ...
            //
            if TGridPanel(ACtrl).Color = clNone then begin
