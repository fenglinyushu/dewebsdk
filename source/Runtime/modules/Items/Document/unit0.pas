...
procedure TForm_Item.BitBtn_UploadEndDock(Sender, Target: TObject; X, Y: Integer);
var
    sFile   : string;
    sExt    : string;
begin
...
procedure TForm_Item.BitBtn_UploadStartDock(Sender: TObject; var DragObject: TDragDockObject);
begin
...
procedure TForm_Item.Button_AllTypeClick(Sender: TObject);
var
    I   : Integer;
begin
    //清空其他
...
procedure TForm_Item.Button_DocClick(Sender: TObject);
var
    bFound  : Boolean;
    I       : Integer;
begin
...
procedure TForm_Item.Button_DownloadClick(Sender: TObject);
var
    iRow    : Integer;
    sID     : String;
    sFile   : String;
...
procedure TForm_Item.Button_PreviewClick(Sender: TObject);
var
    iRow    : Integer;
    sID     : String;
    sFile   : String;
...
procedure TForm_Item.ComboBox_OrderChange(Sender: TObject);
begin
    UpdateData(TrackBar1.Position);
end;
...
function TForm_Item.GetOrder: String;
begin
...
function TForm_Item.GetTypeWhere: String;
begin
...
procedure TForm_Item.StringGrid1DblClick(Sender: TObject);
var
    iRow    : Integer;
begin
    //行
