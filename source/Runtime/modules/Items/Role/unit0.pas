...
procedure TForm_Item.B_ResetClick(Sender: TObject);
begin
...
procedure TForm_Item.Button_RenameClick(Sender: TObject);
begin
    //确认重命名
...
procedure TForm_Item.B_Role1Click(Sender: TObject);
var
    I,J         : Integer;
    sText       : String;
    sCaption    : string;
...
procedure TForm_Item.B_SaveRightsClick(Sender: TObject);
var
    I,J         : Integer;
    joRights    : Variant;
    joRight     : Variant;
...
procedure TForm_Item.ToggleSwitch_1Click(Sender: TObject);
var
    sText   : String;
    I       : Integer;
    sCaption: String;
