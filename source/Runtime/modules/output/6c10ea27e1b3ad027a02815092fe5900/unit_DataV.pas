...
procedure TForm_DataV.Button1Click(Sender: TObject);
begin
    dwEcharts(Memo2);
end;

procedure TForm_DataV.FormMouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
    I       : Integer;
const
...
procedure TForm_DataV.FormMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
    iW,iH   : Integer;
    sCode   : String;
begin
