  ...
  performPrint: function performPrint() {
    ...
    return new Promise(function (resolve) {
      setTimeout(function () {
        ...
        print.call(window);
        //setTimeout(resolve, 20); // by FM to resolve: UNG-2570. Also here: https://github.com/mozilla/pdf.js/issues/7597
      }, 0);
    });
  },
...
function renderProgress(index, total, l10n) {
  ...
  if (progress >= 99) {
  	document.getElementById('printCancel').innerHTML = 'Done'; //  added by FM to resolve: UNG-2570. Also here: https://github.com/mozilla/pdf.js/issues/7597
	}
