...
{$ENDIF}
  ...
  TOTAProcessType = (optWin32, optOSX32, optWin64, optiOS32, optAndroid, optiOS64, optLinux64, optOSX64, optAndroid64);
...
{$ENDIF}
  ...
  IOTAIDEWaitDialogServices270 = interface(IInterface)
   ...
   function IsVisible: Boolean;
    ...
    /// </summary>
    procedure Show(const Caption, TitleMessage: string);
    /// <summary>
    ...
    /// </summary>
    procedure UpdateCurrentWork(const AMessage: string);
    /// <summary>
