...
uses
    ...
    Data.DB,Data.Win.ADODB, Vcl.DBGrids, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Error,
...
procedure TForm1.B_UploadClick(Sender: TObject);
begin
    //
...
begin
    ...
    dwMessage(Format('源文件：%s, 上传文件:%s',[sSource,sLast]),'success',self);
end;
...
begin
    Label_Title.Caption := IntToStr(GetTickCount);
end;
