...
var
     Form_bop_Star2             : TForm_bop_Star2;
...
procedure TForm_bop_Star2.Bt1Click(Sender: TObject);
begin
    //刷新表一
    cpUpdate(Pn1);
    ...
    //
    dwMessage('示例二数据已刷新!','success',self);
end;

procedure TForm_bop_Star2.FormShow(Sender: TObject);
begin
    ...
    //插入自定义的按钮
    cpAddInButtons(Pn2,Bt2);
    Bt2.Left    := 999;
    cpAddInButtons(Pn2,Bt1);
    Bt1.Left    := 999;
end;
