object Form_sys_Student: TForm_sys_Student
  ...
  object Pn1: TPanel
    ...
    Hint = 
      ...
      '"},{"name":"sSource","caption":"'#23478#24237#20303#22336'","sort":1,"query":1,"width"' +
      ':180},{"name":"sRemark","caption":"'#22791#27880'","query":1,"sort":1,"width' +
      '":80},{"name":"sId","view":2},{"name":"sGradeNum","view":2},{"na' +
      'me":"sClassNum","view":2}]}'
    Align = alClient
    BevelOuter = bvNone
    Caption = 'Pn1'
