...
uses
  ...
  FireDAC.Phys.SQLiteDef, FireDAC.Stan.ExprFuncs, Vcl.Imaging.jpeg;
...
var
     ...
     gsSuccessHref  : string='/main.dw';      //登录成功后打开的界面
...
begin
     //
     try
          if FileExists('dwlogin.json') then begin
               gjoConfig := TJsonObject.Create;
               gjoConfig.LoadFromFile('dwlogin.json');
               //数据库
