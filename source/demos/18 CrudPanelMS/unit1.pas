...
uses
  ...
  FireDAC.Comp.DataSet, FireDAC.Phys.PGDef, FireDAC.Phys.PG, Vcl.Buttons, FireDAC.Phys.MSSQLDef, FireDAC.Phys.MSSQL;
type
    TForm1 = class(TForm)
    PMaster: TPanel;
...
begin
    ...
    cpSetOneLine(PMaster);
    //
    cpInit(PSlave1,FDConnection1,false,'');
    cpSetOneLine(PSlave1);
...
var
    oFdQuery    : TFDQuery;
begin
    Memo1.Lines.Add(Format('X=%d,Y=%d. %s',[X,Y,' ']));
    ...
    case X of
        ...
        //cpPostBefore : begin
        //    Memo1.Lines.Add(Format('X=%d,Y=%d. %s',[X,Y,'cpPostBefore']));
        //end;
        //cpPostAfter : begin
        //    Memo1.Lines.Add(Format('X=%d,Y=%d. %s',[X,Y,'cpPostAfter']));
        //end;
