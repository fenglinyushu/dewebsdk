...
//添加用户信息
function  glAddLoginInfo(AConfig,AUserName,APassword : String; AConnection:TFDConnection):String;
...
begin
    ...
    try
        ...
        if FileExists(sDir+'Data/'+AConfig+'.json') then begin
            ...
            //
            dwDeleteCookie(AForm,joConfig.cookieprefix+'login');
