...
procedure TForm_Coupon.B_UseClick(Sender: TObject);
var
    sName   : string;
    iID     : Integer;
    oLabel  : TLabel;
...
procedure TForm_Coupon.CB_AmountChange(Sender: TObject);
begin
    UpdateView;

end;

procedure TForm_Coupon.FormCreate(Sender: TObject);
var
    iItem       : Integer;
begin
    //
...
procedure TForm_Coupon.FormShow(Sender: TObject);
begin
    //
    UpdateView;
end;

procedure TForm_Coupon.TBChange(Sender: TObject);
begin
    UpdateView;
end;

procedure TForm_Coupon.UpdateView;
var
    iPage       : Integer;
    iItem       : Integer;
    iMinAmount   : Integer;
begin
    ...
    //设置分页
    FDQuery1.Close;
    FDQuery1.SQL.Text   := 'SELECT count(cid) FROM dmCoupon WHERE camount>='+IntTostr(iMinAmount);
    ...
    //
    FDQuery1.Close;
    FDQuery1.SQL.Text   := 'SELECT * FROM dmCoupon WHERE camount>='+IntTostr(iMinAmount);
