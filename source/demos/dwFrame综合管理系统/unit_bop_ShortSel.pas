...
type
  TForm_bop_ShortSel = class(TForm)
    Pn1: TPanel;
    BtSel: TButton;
    BtRemove: TButton;
...
procedure TForm_bop_ShortSel.BtRemoveClick(Sender: TObject);
var
    iItem       : Integer;
    iCount      : Integer;
    iRow        : Integer;
...
procedure TForm_bop_ShortSel.BtSelClick(Sender: TObject);
var
    iItem       : Integer;
    iCount      : Integer;
    iRow        : Integer;
...
procedure TForm_bop_ShortSel.FormShow(Sender: TObject);
var
    iCurUserId  : Integer;
begin
    //取得当前用户的id
