...
type
  TForm_bop_SuperSQL = class(TForm)
    Pn1: TPanel;
...
var
     Form_bop_SuperSQL             : TForm_bop_SuperSQL;
...
procedure TForm_bop_SuperSQL.FormShow(Sender: TObject);
begin
    //
    cpSetNameValue(Pn1,'table','('+TForm1(self.Owner).gsSuperSQL+') AS SPS');
