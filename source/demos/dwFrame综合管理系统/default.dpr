...
uses
  ...
  unit_bop_Exam in 'unit_bop_Exam.pas' {Form_bop_Exam},
...
begin
    ...
    //设置数据库连接
    if Form1.gsDB = 'pg' then begin
        Form1.FDConnection1.SharedCliHandle  := dwBase.dwGetCliHandleByName(AParams,'dwPG');
    end else begin
        Form1.FDConnection1.SharedCliHandle  := dwBase.dwGetCliHandleByName(AParams,'dwQBank');
    end;
