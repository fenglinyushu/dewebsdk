...
type
  TForm_bop_ClassManager = class(TForm)
    Pn1: TPanel;
...
var
     Form_bop_ClassManager             : TForm_bop_ClassManager;
...
procedure TForm_bop_ClassManager.FormShow(Sender: TObject);
begin
    //
