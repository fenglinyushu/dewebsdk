...
procedure TForm_bop_Judge.FormShow(Sender: TObject);
var
    iCurUserId  : Integer;
begin
    //取得当前用户的id
    ...
    cpSetWhere(Pn1,'qType=''判断题'' AND qCreatorId='+IntToStr(iCurUserId));
    ...
    //设置当前新增的试题类型为判断题
    //cpSetFieldByName(Pn1,'qType','default','判断题');
