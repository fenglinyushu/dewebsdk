...
uses
    ...
    //系统功能
    unit_sys_ChangePsd,         //Change password
    unit_sys_Department,        //Department
    unit_sys_Home,              //Home
    unit_sys_Log,               //System log
    unit_sys_Me,                //me
    unit_sys_Role,              //role
    unit_sys_User,              //use
    unit_sys_QuickBtn,          //quick button
...
type
  ...
  public
    //system
    Form_sys_ChangePsd      : TForm_sys_ChangePsd;      //Change password
    Form_sys_Department     : TForm_sys_Department;     //department
    Form_sys_Home           : TForm_sys_Home;           //home
    Form_sys_Log            : TForm_sys_Log;            //system log
    Form_sys_Me             : TForm_sys_Me;             //me
    Form_sys_QuickBtn       : TForm_sys_QuickBtn;       //quick button
    Form_sys_Role           : TForm_sys_Role;           //role
    Form_sys_User           : TForm_sys_User;           //use
...
procedure TForm1.Department1Click(Sender: TObject);
begin
    //Department
...
begin
    //全屏模块
    dwfShowForm(self,TForm_dem_Full, TForm(Form_dem_Full),TMenuItem(Sender));
end;

procedure TForm1.N4Click(Sender: TObject);
begin
    //隐藏标题
    dwfShowForm(self,TForm_dem_Foot, TForm(Form_dem_Foot),TMenuItem(Sender));
end;
