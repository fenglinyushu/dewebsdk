...
type
  TForm_bop_SelectSel = class(TForm)
    Pn1: TPanel;
    BtSel: TButton;
    BtRemove: TButton;
...
procedure TForm_bop_SelectSel.BtRemoveClick(Sender: TObject);
var
    iItem       : Integer;
    iCount      : Integer;
    iRow        : Integer;
...
procedure TForm_bop_SelectSel.BtSelClick(Sender: TObject);
var
    iItem       : Integer;
    iCount      : Integer;
    iRow        : Integer;
...
procedure TForm_bop_SelectSel.FormShow(Sender: TObject);
var
    iCurUserId  : Integer;
begin
    //取得当前用户的id
