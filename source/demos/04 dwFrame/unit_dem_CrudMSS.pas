...
procedure TForm_dem_CrudMSS.FormShow(Sender: TObject);
var
    joConfig    : Variant;
    joField     : Variant;
    joRight     : variant;
...
begin
    ...
    //合同中的产品的尺寸/数量 CRUD
    cpInit(PnD,TForm1(self.Owner).FDConnection1,false,'');
    cpSetOneLine(PnD);
    ...
    //TPanel(FindComponent('PBs')).Width  := 800;

end;

procedure TForm_dem_CrudMSS.Pn1DragOver(Sender, Source: TObject; X, Y: Integer; State: TDragState; var Accept: Boolean);
var
    oFDQuery    : TFDQuery;
    oFDTemp     : TFDQuery;
    iUserId     : Integer;
...
begin
    ...
    case X of
        ...
        cpAppendPostAfter : begin
            ...
            oFDTemp.Open('SELECT Max(SUBSTRING(cPI_NO, 9, 3)) FROM bop_Contract'
