...
procedure TForm_Supplier.Button_AddClick(Sender: TObject);
var
    iRow    : Integer;
begin
...
procedure TForm_Supplier.Button_DeleteClick(Sender: TObject);
var
    iRow    : Integer;
begin
    iRow := StringGrid1.Row;
...
procedure TForm_Supplier.Button_SaveClick(Sender: TObject);
var
    iRow    : Integer;
begin
    iRow := StringGrid1.Row;
...
procedure TForm_Supplier.Button_SearchClick(Sender: TObject);
begin
...
procedure TForm_Supplier.Button_ShowClick(Sender: TObject);
var
    oForm   : TForm1;
begin
...
procedure TForm_Supplier.FormResize(Sender: TObject);
 var
    sWidth  : Integer;
    iCol    : Integer;
begin
...
procedure TForm_Supplier.FormStartDock(Sender: TObject; var DragObject: TDragDockObject);
var
    sMethod : string;
    sValue  : string;
    iRow    : Integer;
...
procedure TForm_Supplier.StringGrid1Click(Sender: TObject);
var
    iRow    : Integer;
begin
    //行
...
procedure TForm_Supplier.TrackBar1Change(Sender: TObject);
begin
    dwaGetDataToGrid(FDQuery1,'wms_Supplier','ID,名称,联系人,联系电话,地址,邮编,邮箱,总体介绍,备注',
...
procedure TForm_Supplier.UpdateData(APage: Integer);
begin
    dwaGetDataToGrid(FDQuery1,'wms_Supplier','ID,名称,联系人,联系电话,地址,邮编,邮箱,总体介绍,备注',
...
procedure TForm_Supplier.UpdateInfos;
begin
    //
end;
