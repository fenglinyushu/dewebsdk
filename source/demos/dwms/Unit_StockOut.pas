...
procedure TForm_StockOut.Button7Click(Sender: TObject);
var
    iPID    : Integer;
...
procedure TForm_StockOut.Button_Search2Click(Sender: TObject);
begin
    dwaGetDataToGrid(FDQuery1,'wms_Inventory','ID,名称,型号,供应商,仓库,单位,单价,数量',
...
procedure TForm_StockOut.FormCreate(Sender: TObject);
begin
...
procedure TForm_StockOut.FormResize(Sender: TObject);
begin
    with StringGrid1 do begin
...
procedure TForm_StockOut.TrackBar1Change(Sender: TObject);
begin
    dwaGetDataToGrid(FDQuery1,'wms_Inventory','ID,名称,型号,供应商,仓库,单位,单价,数量',
...
procedure TForm_StockOut.UpdateData(APage: Integer);
begin
    dwaGetDataToGrid(FDQuery1,'wms_Inventory','ID,名称,型号,供应商,仓库,单位,单价,数量',
...
procedure TForm_StockOut.UpdateInfos;
var
    I       : Integer;
begin
    //
