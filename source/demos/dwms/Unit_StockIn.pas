...
procedure TForm_StockIn.Button1Click(Sender: TObject);
var
    iPID    : Integer;
...
procedure TForm_StockIn.Button5Click(Sender: TObject);
begin
    //
    UpdateInfos;
end;

procedure TForm_StockIn.FormCreate(Sender: TObject);
begin
...
procedure TForm_StockIn.FormResize(Sender: TObject);
begin
    with StringGrid1 do begin
...
procedure TForm_StockIn.TrackBar1Change(Sender: TObject);
begin
    dwaGetDataToGrid(FDQuery1,'wms_Inventory','ID,名称,型号,供应商,仓库,单位,单价,数量',
...
procedure TForm_StockIn.UpdateData(APage: Integer);
begin
    dwaGetDataToGrid(FDQuery1,'wms_Inventory','ID,名称,型号,供应商,仓库,单位,单价,数量',
            '','ORDER BY id DESC',APage,10,StringGrid1,TrackBar1);
end;

procedure TForm_StockIn.UpdateInfos;
var
    I       : Integer;
begin
    //
