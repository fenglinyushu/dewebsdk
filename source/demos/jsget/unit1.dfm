object Form1: TForm1
  ...
  object Label2: TLabel
    ...
    AutoSize = False
    Caption = 
      #20363#65306'alert('#39'hello,world!'#39');this.Button1__cap='#39'btn1'#39';this.Label1__ca' +
      'p='#39'DEWEB'#39';'
    Font.Charset = ANSI_CHARSET
    Font.Color = 6579300
    Font.Height = -15
  ...
  object Label3: TLabel
    ...
    Align = alTop
    AutoSize = False
    Caption = #27880#24847#65306#23383#31526#20018#35831#29992#21333#24341#21495#65281#65281#65281
    Font.Charset = ANSI_CHARSET
    Font.Color = 6579300
    Font.Height = -15
    Font.Name = #24494#36719#38597#40657
  ...
  object Button1: TButton
    ...
    Width = 993
    Height = 45
    Hint = '{"type":"success","borderradius":"23px"}'
    Margins.Top = 20
    Margins.Bottom = 10
    Align = alTop
  ...
  object Edit1: TEdit
    ...
    TabOrder = 1
    Text = 
      'let me=this;axios.get('#39'{"m":"interaction","i":'#39'+this.clientid+'#39',' +
      '"t":"varname","v":"varvalue"}'#39').then(resp =>{me.procResp(resp.da' +
      'ta)});'
    ExplicitWidth = 344
  end
  object Panel_00_Title: TPanel
    ...
    object Label1: TLabel
      ...
      Align = alClient
      AutoSize = False
      Caption = 'DeWeb JavaScript To Form'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -15
      Font.Name = 'Verdana'
