...
procedure TForm_QuickBtn.BSClick(Sender: TObject);
var
    joQuickBtn  : Variant;
    iItem       : Integer;
    oForm1      : TForm1;
...
begin
    try
        ...
        FDQuery1.Close;
        FDQuery1.SQL.Text   := 'UPDATE eUser'
        ...
        //<更新首页快捷按钮
        for iItem := 0 to 7 do begin
            oPanel  := TPanel(oForm1.Form_Home.FindComponent('P1'+IntToStr(iItem)));
            oPanel.Caption  := oForm1.gjoUserInfo.quickbutton._(iItem)._(0);
            oPanel.Hint     := '{"radius":"5px","src":"media/images/32/a ('+IntToStr(oForm1.gjoUserInfo.quickbutton._(iItem)._(1))+').png","dwstyle":"border:solid 1px #eee;"}';
        end;
        //>
...
procedure TForm_QuickBtn.C0Change(Sender: TObject);
var
    iItem   : Integer;
begin
    //
...
procedure TForm_QuickBtn.FormShow(Sender: TObject);
var
    iItem       : Integer;
    slMenu      : TStringList;
    oPanel      : TPanel;
...
procedure TForm_QuickBtn.S0Change(Sender: TObject);
var
    iItem   : Integer;
begin
    //
