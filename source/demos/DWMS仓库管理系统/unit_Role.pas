...
procedure TForm_Role.B_FalseClick(Sender: TObject);
var
    iItem       : integer;
    joText      : Variant;
    tnNode      : TTreeNode;
...
procedure TForm_Role.B_SaveClick(Sender: TObject);
var
    sText       : string;
    //
    joText      : Variant;
...
procedure TForm_Role.B_TrueClick(Sender: TObject);
var
    iItem       : integer;
    joText      : Variant;
    tnNode      : TTreeNode;
...
procedure TForm_Role.B_EditPlusClick(Sender: TObject);
begin
    P_InfoEdit.Visible  := True;
end;

procedure TForm_Role.FormDockDrop(Sender: TObject; Source: TDragDockObject; X, Y: Integer);
var
    oFDQuery    : TFDQuery;
    //
    sRoleData   : String;
...
procedure TForm_Role.Pn1DragOver(Sender, Source: TObject; X, Y: Integer; State: TDragState; var Accept: Boolean);
var
    oFDQuery    : TFDQuery;
    //
    sRoleData   : String;
...
procedure TForm_Role.TV_PermissionEndDock(Sender, Target: TObject; X, Y: Integer);
var
    tnNode      : TTreeNode;
    joText      : Variant;
begin
