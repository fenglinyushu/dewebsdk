...
Version:      V9.0
Legal issues: Portions Copyright (C) 2006-2023 by Arno Garrels, Berlin, Germany,
...
Jul 18, 2023 V8.71 Corrected DECRYPT_MESSAGE_FN declaration.
                   Removed ULONG_PTR declaration, not Win64 compatible, use
                     OverbyteIcsTypes instead.
...
type
  {x$EXTERNALSYM ULONG_PTR}
{ ULONG_PTR = Longword;       V8.71 not needed, defined in types }
...
{$ENDIF}
  ...
  DECRYPT_MESSAGE_FN               = function(phContext: PCtxtHandle; pMessage: PSecBufferDesc; MessageSeqNo: Cardinal; fQOP: PULONG): SECURITY_STATUS; stdcall;   { V8.71 corrected fQOP to pointer }
