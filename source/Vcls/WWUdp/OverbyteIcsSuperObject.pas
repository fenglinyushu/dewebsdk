...
function SearchInAll(inWhat: ISuperObject; const findThis: string): string;     { V8.71 }
...
{ search for first name anywhere in nested JSON objects or arrays, returns value or blank if not found }
function SearchInAll(inWhat: ISuperObject; const findThis: string): string;     { V8.71 }
var
